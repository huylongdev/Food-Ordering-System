    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (commentIdParam != null && !commentIdParam.isEmpty()) {
                ...
                // Handle the case where commentID is null or empty
                System.out.println("Comment ID is missing.");
            }
            CommentDAO commentDAO = new CommentDAO();
            boolean success = commentDAO.deleteComment(commentId);
            if (success) {
                response.sendRedirect("blogdetails?postId=" + request.getParameter("postId"));
            } else {
